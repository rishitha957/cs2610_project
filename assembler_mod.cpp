...
int main()
{
    ...
    int val;
    string ins,op,r1,r2,r3,comment;
    ...
    while(getline(inputFile,ins))
    {
        ...
        if(ins.size()==0)
        {
            cout << "Invalid: Instruction is empty in line: "<<count << endl;
        ...
        if(J_TYPE.find(op)!=J_TYPE.end())
        {
            ...
            {
            	cout<<"error!!! "<<endl;
                cout << "suggestion: value can not be neg in line: " <<count<< endl;
                outputFile1 << "invalid: value can not be neg" << endl;
            }
            else if(val>67108869)
            {
            	cout<<"error!!! "<<endl;
                cout << "suggestion: value is too large in line :" <<count<< endl;
                outputFile1 << "invalid: value is too large" << endl;
            }
            else if(ss>>comment&&(comment[0]!='/'||comment[1]!='/'))
            {
            	cout<<"error!!! "<<endl;
            	cout << "suggestion: comment structure not maintained in line :" <<count<< endl;
        ...
        if(op!="jr")
        {
            ...
            {
            	cout<<"error!!! "<<endl;
                cout << "suggestion: '$' sign is missing before rd in line :" <<count<< endl;
            ...
            {
            	cout<<"error!!! "<<endl;
                cout << "suggestion: ',' is missing after rd in line :" <<count<< endl;
        ...
        if(R_TYPE.find(op)!=R_TYPE.end())
        {
            ...
            else
            {
                ...
                {
                	cout<<"error!!! "<<endl;
                    cout << "suggestion: '$' sign is missing before rs in line :" <<count<< endl;
                ...
                {
                	cout<<"error!!! "<<endl;
                    cout << "suggestion: ',' is missing after rs in line :" <<count<< endl;
            ...
            {
            	cout<<"error!!! "<<endl;
                cout << "suggestion: '$' sign is missing before rt in line :" <<count<< endl;
            ...
            if(op=="sll"||op=="srl")
            {
                ...
                {
                	cout<<"error!!! "<<endl;
                    cout << "suggestion: ',' is missing after rt in line :" <<count<< endl;
        ...
        else if(I_TYPE.find(op)!=I_TYPE.end())
        {
        	...
        	if(op=="lw"||op=="sw")
        	{
                ...
                {
                	cout<<"error!!! "<<endl;
                    cout << "suggestion: '(' is missing before rs in line :" <<count<< endl;
        		...
        		if(r1=="$zero")
                {
                    r1 = "";
                    cout<<"error!!! "<<endl;
                    cout << "suggestion: $zero can to be used in line :" <<count<< endl;
            ...
            {
            	cout<<"error!!! "<<endl;
                cout << "suggestion: value is too small in line :" <<count<< endl;
        ...
        {
        	cout<<"error!!! "<<endl;
        	cout << "suggestion: Op code not found in line :" <<count<< endl;
